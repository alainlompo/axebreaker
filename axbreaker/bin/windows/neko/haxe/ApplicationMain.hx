...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Alain Lompo", "axbreaker", "org.hypernovae.games.axbreaker.axbreaker", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (org.hypernovae.games.axbreaker.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (org.hypernovae.games.axbreaker.Main, Reflect.field (org.hypernovae.games.axbreaker.Main, "main"), []);
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "axbreaker", null, { width: 500, height: 500 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (org.hypernovae.games.axbreaker.Main, []);
			}
...
import org.hypernovae.games.axbreaker.Main;
